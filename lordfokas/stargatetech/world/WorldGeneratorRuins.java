...
public final class WorldGeneratorRuins {
	...
	private static void generateLootChest(Random r, World w, int x, int y, int z){
		w.setBlockAndMetadataWithNotify(x, y, z, Block.chest.blockID, 0, Helper.SETBLOCK_UPDATE);
	...
	private static void generateGrassRuin(Random r, World w, int x, int y, int z){
		...
		w.setBlockAndMetadataWithNotify(x, y-2, z, block, 0, Helper.SETBLOCK_UPDATE);
		WorldGenerationHelper.instance.generateHRect(w, x-1, y-1, z-1, 3, 3, block, 0);
		WorldGenerationHelper.instance.generateHRect(w, x-2, y+0, z-2, 5, 5, block, 0);
		WorldGenerationHelper.instance.generateHRectCorner(w, x-2, y+1, z-2, 5, 5, 0, 0, block, 3);
		WorldGenerationHelper.instance.generateHRectCorner(w, x-2, y+2, z-2, 5, 5, 0, 0, block, 3);
		WorldGenerationHelper.instance.generateHRectCorner(w, x-2, y+3, z-2, 5, 5, 0, 0, block, 3);
		WorldGenerationHelper.instance.generateHRectCorner(w, x-2, y+4, z-2, 5, 5, 0, 0, block, 3);
		WorldGenerationHelper.instance.generateHRect(w, x-2, y+5, z-2, 5, 5, block, 0);
	...
	private static void generateDesertRuin(Random r, World w, int x, int y, int z){
		...
		WorldGenerationHelper.instance.generateHRect(w, x-1, y-1, z-1, 3, 3, block, 0);
		WorldGenerationHelper.instance.generateHRect(w, x-2, y+0, z-2, 5, 5, block, 0);
		WorldGenerationHelper.instance.generateHRectCorner(w, x-2, y+1, z-2, 5, 5, 0, 0, block, 1);
		WorldGenerationHelper.instance.generateHRectCorner(w, x-2, y+2, z-2, 5, 5, 0, 0, block, 1);
		WorldGenerationHelper.instance.generateHRectCorner(w, x-2, y+3, z-2, 5, 5, 0, 0, block, 1);
		WorldGenerationHelper.instance.generateHRectCorner(w, x-2, y+4, z-2, 5, 5, 0, 0, block, 1);
		WorldGenerationHelper.instance.generateHRect(w, x-2, y+5, z-2, 5, 5, block, 2);
		generateLootChest(r, w, x, y, z);
	}
	...
	private static void generateWaterRuin(Random r, World w, int x, int y, int z){
		...
		w.setBlockAndMetadataWithNotify(x, y-2, z, shield, 0, Helper.SETBLOCK_UPDATE);
		WorldGenerationHelper.instance.generateHRect(w, x-1, y-1, z-1, 3, 3, stone, 0);
		WorldGenerationHelper.instance.generateHRect(w, x-2, y+0, z-2, 5, 5, stone, 0);
		WorldGenerationHelper.instance.generateHRectCorner(w, x-2, y+1, z-2, 5, 5, 0, 0, stone, 3);
		WorldGenerationHelper.instance.generateHRectCorner(w, x-2, y+2, z-2, 5, 5, 0, 0, stone, 3);
		WorldGenerationHelper.instance.generateHRectCorner(w, x-2, y+3, z-2, 5, 5, 0, 0, stone, 3);
		WorldGenerationHelper.instance.generateHRectCorner(w, x-2, y+4, z-2, 5, 5, 0, 0, stone, 3);
		WorldGenerationHelper.instance.generateHRect(w, x-1, y+5, z-1, 3, 3, shield, meta);
		WorldGenerationHelper.instance.generateHRectFrame(w, x-2, y+5, z-2, 5, 5, stone, 0);
		
		WorldGenerationHelper.instance.generateVRectX(w, x-2, y+1, z-1, 4, 3, shield, meta);
		WorldGenerationHelper.instance.generateVRectX(w, x+2, y+1, z-1, 4, 3, shield, meta);
		WorldGenerationHelper.instance.generateVRectZ(w, x-1, y+1, z-2, 3, 4, shield, meta);
		WorldGenerationHelper.instance.generateVRectZ(w, x-1, y+1, z+2, 3, 4, shield, meta);
