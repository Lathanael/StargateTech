package lathanael.stargatetech.rendering;
...
public class RenderStargatePainting extends Render {

	public void renderThePainting(EntityStargatePainting par1EntityPainting,
		...
		this.func_77010_a(par1EntityPainting, enumart.sizeX, enumart.sizeY,
				enumart.offsetX, enumart.offsetY);
		GL11.glDisable(GL12.GL_RESCALE_NORMAL);
		GL11.glPopMatrix();
	}

	private void func_77010_a(EntityStargatePainting par1EntityPainting,
	...
	private void func_77008_a(EntityStargatePainting par1EntityPainting,
		...
		int l = this.renderManager.worldObj.getLightBrightnessForSkyBlocks(i,
				j, k, 0);
		int i1 = l % 65536;
		int j1 = l / 65536;
	...
	public void doRender(Entity par1Entity, double par2, double par4,
		...
		this.renderThePainting((EntityStargatePainting) par1Entity, par2, par4,
				par6, par8, par9);
	}
}
